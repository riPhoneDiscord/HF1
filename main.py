...
class HF1(commands.Bot):
    ...
    async def on_ready(self):
        ...
        pstatus = f"wAffles mukbang"
        await self.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name=pstatus), status=discord.Status.idle)
